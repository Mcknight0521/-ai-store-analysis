...
display_css='<link rel="stylesheet" href="assets/opspilot-display.css?v=13.0.0">'
js='<script src="assets/opspilot-v7.js?v=13.0.0"></script>'
import re
...
print('OpsPilot fresh display layer linked; business logic untouched')
